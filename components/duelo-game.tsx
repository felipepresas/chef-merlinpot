      ...
      <div className="flex flex-col items-center py-8 text-center">
        ...
        <div className="mt-8 flex w-full max-w-xs flex-col gap-3">
          <button
            onClick={() => start("LUNCH")}
            disabled={loading}
            className="rounded-xl border border-ink/10 bg-white px-4 py-3 font-medium text-ink transition hover:border-brand disabled:opacity-60"
          >
            Duelo de almuerzos
          </button>
          <button
      ...
      <div className="flex flex-col items-center py-8 text-center">
        ...
        <div className="mt-6 flex w-full max-w-sm flex-col gap-3">
          ...
          <Link
            ...
            className="rounded-xl border border-ink/10 bg-white px-4 py-3 text-center font-medium text-ink transition hover:border-brand"
          >
            Ver receta
          </Link>
          <button
        ...
        <div className="flex flex-col items-stretch gap-3">
          {[pair[0], pair[1]].map((r, idx) => (
            <div key={r.id} className="contents">
              <button
                onClick={() => choose(r)}
                className="group rounded-2xl border-2 border-ink/5 bg-white p-6 text-center transition hover:border-brand hover:shadow-md"
              >
